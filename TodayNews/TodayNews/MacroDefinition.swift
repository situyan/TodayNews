...
// 顶部和底部安全区域宏
let SafeAreaTopHeight: CGFloat = (SCREEN_HEIGHT >= 812.0) ? 88.0 : 64.0
let SafeAreaBottomHeight: CGFloat = (SCREEN_HEIGHT >= 812.0) ? 34.0 : 0
// 状态栏高度
let TopStatuBarHeight: CGFloat = (SCREEN_HEIGHT >= 812.0) ? 44.0 : 20.0
// iPhone X系列机型导航栏多出高度
let MoreNavigationBarHeight: CGFloat = (SCREEN_HEIGHT >= 812.0) ? 24.0 : 0
